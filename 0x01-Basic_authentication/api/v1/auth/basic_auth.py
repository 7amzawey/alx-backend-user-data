...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(
        ...
        """Return the Base64 part of the Authorization header for Basic."""
    ...
    def extract_user_credentials(
        ...
        if ':' not in decoded_base64_authorization_header:
            return (None, None)
        usr_pass = decoded_base64_authorization_header.split(':')
        return (usr_pass[0], usr_pass[1])
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        if decoded_auth == None:
            return None
        usr_email, usr_pwd = self.extract_user_credentials(decoded_auth)
